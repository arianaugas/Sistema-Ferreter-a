...
async function cargarUsuarioActual() {
    try {
        ...
        // <span class="d-none d-md-block small fw-semibold">Juan Pérez</span>
        ...
        // <p class="mb-0 fw-semibold">Juan Pérez</p>
        ...
        // Guardar en memoria para que otros módulos lo usen si lo necesitan
...
/* 
   ...
   Endpoint: GET /api/reportes/dashboard/alertas
   Response: { ok, alertas: { stock_bajo, sin_stock, ordenes_pendientes, total_alertas } }

   Tipos de notificación generados:
     🔴 Sin stock     → productos con stock_actual <= 0
     🟡 Stock bajo    → productos con stock_actual < stock_minimo (pero > 0)
     🔵 Órdenes       → órdenes de compra enviadas pendientes de recibir
    */
