...
router.post('/sub/', revisarToken, accesoProductos , subCatCtrl.crear);
router.put('/sub/:id', revisarToken, accesoProductos , subCatCtrl.actualizar);
...
router.post('/cat/', revisarToken, accesoProductos , catCtrl.crearCategoria);
router.put('/cat/:id', revisarToken, accesoProductos , catCtrl.actualizarCategoria);
